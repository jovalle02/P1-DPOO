...
public class Fotografia extends Pieza {
    ...
    public Fotografia(String id, String titulo, String autor, String anioCreacion, String lugarCreacion, Boolean exhibicion, double valor, Boolean valorfijo,String estado, double alto, double ancho,
                      String formato, String tecnica, double resolucion, boolean disponible, boolean vendida) {
        super(id, "Fotografia", titulo, autor, anioCreacion, lugarCreacion, exhibicion, valor, valorfijo, estado, alto, ancho, disponible, vendida);
